...
* [zx7](https://spectrumcomputing.co.uk/index.php?cat=96&id=27996), `mktap`, `bintap` (ask your ZX Spectrum guru for links)
...
* Каждая часть сжимается паковщиком **zx7** (должен быть доступен в системе)
